...
/* Packets, enums and structures for V3D _.p.
 *
 * This file has been generated, do not hand edit.
 */

#ifndef V3D_packet_v33_PACK_H
#define V3D_packet_v33_PACK_H

#include "cle/v3d_packet_helpers.h"


enum V3D_packet_v33_Compare_Function {
...
enum V3D_packet_v33_Blend_Factor {
...
enum V3D_packet_v33_Blend_Mode {
...
enum V3D_packet_v33_Stencil_Op {
...
enum V3D_packet_v33_Border_Color_Mode {
...
enum V3D_packet_v33_L2T_Flush_Mode {
        L2T_FLUSH_MODE_FLUSH                 =      0,
        L2T_FLUSH_MODE_CLEAR                 =      1,
        L2T_FLUSH_MODE_CLEAN                 =      2,
};

enum V3D_packet_v33_Output_Image_Format {
...
enum V3D_packet_v33_Dither_Mode {
...
enum V3D_packet_v33_Pack_Mode {
        V3D_PACK_MODE_16_WAY                 =      0,
        V3D_PACK_MODE_8_WAY                  =      1,
        V3D_PACK_MODE_4_WAY                  =      2,
};

enum V3D_packet_v33_TCS_flush_mode {
        V3D_TCS_FLUSH_MODE_FULLY_PACKED      =      0,
        V3D_TCS_FLUSH_MODE_SINGLE_PATCH      =      1,
        V3D_TCS_FLUSH_MODE_PACKED_COMPLETE_PATCHES =      2,
};

#define V3D_packet_v33_HALT_opcode             0
#define V3D_packet_v33_HALT_header              \
   .opcode                              =      0

struct V3D_packet_v33_HALT {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_HALT_pack(__gen_user_data *data, uint8_t * restrict cl,
                         const struct V3D_packet_v33_HALT * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_HALT_length             1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_HALT_unpack(const uint8_t * restrict cl,
                           struct V3D_packet_v33_HALT * restrict values)
{
...
#define V3D_packet_v33_NOP_opcode              1
#define V3D_packet_v33_NOP_header               \
   .opcode                              =      1

struct V3D_packet_v33_NOP {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_NOP_pack(__gen_user_data *data, uint8_t * restrict cl,
                        const struct V3D_packet_v33_NOP * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_NOP_length              1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_NOP_unpack(const uint8_t * restrict cl,
                          struct V3D_packet_v33_NOP * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_FLUSH_opcode            4
#define V3D_packet_v33_FLUSH_header             \
   .opcode                              =      4

struct V3D_packet_v33_FLUSH {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_FLUSH_pack(__gen_user_data *data, uint8_t * restrict cl,
                          const struct V3D_packet_v33_FLUSH * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_FLUSH_length            1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_FLUSH_unpack(const uint8_t * restrict cl,
                            struct V3D_packet_v33_FLUSH * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_FLUSH_ALL_STATE_opcode      5
#define V3D_packet_v33_FLUSH_ALL_STATE_header   \
   .opcode                              =      5

struct V3D_packet_v33_FLUSH_ALL_STATE {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_FLUSH_ALL_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D_packet_v33_FLUSH_ALL_STATE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_FLUSH_ALL_STATE_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_FLUSH_ALL_STATE_unpack(const uint8_t * restrict cl,
                                      struct V3D_packet_v33_FLUSH_ALL_STATE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_START_TILE_BINNING_opcode      6
#define V3D_packet_v33_START_TILE_BINNING_header\
   .opcode                              =      6

struct V3D_packet_v33_START_TILE_BINNING {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_START_TILE_BINNING_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D_packet_v33_START_TILE_BINNING * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_START_TILE_BINNING_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_START_TILE_BINNING_unpack(const uint8_t * restrict cl,
                                         struct V3D_packet_v33_START_TILE_BINNING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_INCREMENT_SEMAPHORE_opcode      7
#define V3D_packet_v33_INCREMENT_SEMAPHORE_header\
   .opcode                              =      7

struct V3D_packet_v33_INCREMENT_SEMAPHORE {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_INCREMENT_SEMAPHORE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                        const struct V3D_packet_v33_INCREMENT_SEMAPHORE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_INCREMENT_SEMAPHORE_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_INCREMENT_SEMAPHORE_unpack(const uint8_t * restrict cl,
                                          struct V3D_packet_v33_INCREMENT_SEMAPHORE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_WAIT_ON_SEMAPHORE_opcode      8
#define V3D_packet_v33_WAIT_ON_SEMAPHORE_header \
   .opcode                              =      8

struct V3D_packet_v33_WAIT_ON_SEMAPHORE {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_WAIT_ON_SEMAPHORE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                      const struct V3D_packet_v33_WAIT_ON_SEMAPHORE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_WAIT_ON_SEMAPHORE_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_WAIT_ON_SEMAPHORE_unpack(const uint8_t * restrict cl,
                                        struct V3D_packet_v33_WAIT_ON_SEMAPHORE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_WAIT_FOR_PREVIOUS_FRAME_opcode      9
#define V3D_packet_v33_WAIT_FOR_PREVIOUS_FRAME_header\
   .opcode                              =      9

struct V3D_packet_v33_WAIT_FOR_PREVIOUS_FRAME {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_WAIT_FOR_PREVIOUS_FRAME_pack(__gen_user_data *data, uint8_t * restrict cl,
                                            const struct V3D_packet_v33_WAIT_FOR_PREVIOUS_FRAME * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_WAIT_FOR_PREVIOUS_FRAME_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_WAIT_FOR_PREVIOUS_FRAME_unpack(const uint8_t * restrict cl,
                                              struct V3D_packet_v33_WAIT_FOR_PREVIOUS_FRAME * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_ENABLE_Z_ONLY_RENDERING_opcode     10
#define V3D_packet_v33_ENABLE_Z_ONLY_RENDERING_header\
   .opcode                              =     10

struct V3D_packet_v33_ENABLE_Z_ONLY_RENDERING {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_ENABLE_Z_ONLY_RENDERING_pack(__gen_user_data *data, uint8_t * restrict cl,
                                            const struct V3D_packet_v33_ENABLE_Z_ONLY_RENDERING * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_ENABLE_Z_ONLY_RENDERING_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_ENABLE_Z_ONLY_RENDERING_unpack(const uint8_t * restrict cl,
                                              struct V3D_packet_v33_ENABLE_Z_ONLY_RENDERING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_DISABLE_Z_ONLY_RENDERING_opcode     11
#define V3D_packet_v33_DISABLE_Z_ONLY_RENDERING_header\
   .opcode                              =     11

struct V3D_packet_v33_DISABLE_Z_ONLY_RENDERING {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_DISABLE_Z_ONLY_RENDERING_pack(__gen_user_data *data, uint8_t * restrict cl,
                                             const struct V3D_packet_v33_DISABLE_Z_ONLY_RENDERING * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_DISABLE_Z_ONLY_RENDERING_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_DISABLE_Z_ONLY_RENDERING_unpack(const uint8_t * restrict cl,
                                               struct V3D_packet_v33_DISABLE_Z_ONLY_RENDERING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_END_OF_Z_ONLY_RENDERING_IN_FRAME_opcode     12
#define V3D_packet_v33_END_OF_Z_ONLY_RENDERING_IN_FRAME_header\
   .opcode                              =     12

struct V3D_packet_v33_END_OF_Z_ONLY_RENDERING_IN_FRAME {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_END_OF_Z_ONLY_RENDERING_IN_FRAME_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                     const struct V3D_packet_v33_END_OF_Z_ONLY_RENDERING_IN_FRAME * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_END_OF_Z_ONLY_RENDERING_IN_FRAME_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_END_OF_Z_ONLY_RENDERING_IN_FRAME_unpack(const uint8_t * restrict cl,
                                                       struct V3D_packet_v33_END_OF_Z_ONLY_RENDERING_IN_FRAME * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_END_OF_RENDERING_opcode     13
#define V3D_packet_v33_END_OF_RENDERING_header  \
   .opcode                              =     13

struct V3D_packet_v33_END_OF_RENDERING {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_END_OF_RENDERING_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D_packet_v33_END_OF_RENDERING * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_END_OF_RENDERING_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_END_OF_RENDERING_unpack(const uint8_t * restrict cl,
                                       struct V3D_packet_v33_END_OF_RENDERING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_WAIT_FOR_TRANSFORM_FEEDBACK_opcode     14
#define V3D_packet_v33_WAIT_FOR_TRANSFORM_FEEDBACK_header\
   .opcode                              =     14

struct V3D_packet_v33_WAIT_FOR_TRANSFORM_FEEDBACK {
   uint32_t                             opcode;
   uint32_t                             block_count;
};

static inline void
V3D_packet_v33_WAIT_FOR_TRANSFORM_FEEDBACK_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                const struct V3D_packet_v33_WAIT_FOR_TRANSFORM_FEEDBACK * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_WAIT_FOR_TRANSFORM_FEEDBACK_length      2
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_WAIT_FOR_TRANSFORM_FEEDBACK_unpack(const uint8_t * restrict cl,
                                                  struct V3D_packet_v33_WAIT_FOR_TRANSFORM_FEEDBACK * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_BRANCH_TO_AUTO_CHAINED_SUB_LIST_opcode     15
#define V3D_packet_v33_BRANCH_TO_AUTO_CHAINED_SUB_LIST_header\
   .opcode                              =     15

struct V3D_packet_v33_BRANCH_TO_AUTO_CHAINED_SUB_LIST {
   uint32_t                             opcode;
   __gen_address_type                   address;
};

static inline void
V3D_packet_v33_BRANCH_TO_AUTO_CHAINED_SUB_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                    const struct V3D_packet_v33_BRANCH_TO_AUTO_CHAINED_SUB_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_BRANCH_TO_AUTO_CHAINED_SUB_LIST_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_BRANCH_TO_AUTO_CHAINED_SUB_LIST_unpack(const uint8_t * restrict cl,
                                                      struct V3D_packet_v33_BRANCH_TO_AUTO_CHAINED_SUB_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_BRANCH_opcode          16
#define V3D_packet_v33_BRANCH_header            \
   .opcode                              =     16

struct V3D_packet_v33_BRANCH {
   uint32_t                             opcode;
   __gen_address_type                   address;
};

static inline void
V3D_packet_v33_BRANCH_pack(__gen_user_data *data, uint8_t * restrict cl,
                           const struct V3D_packet_v33_BRANCH * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_BRANCH_length           5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_BRANCH_unpack(const uint8_t * restrict cl,
                             struct V3D_packet_v33_BRANCH * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 8, 39);
}
...
#define V3D_packet_v33_BRANCH_TO_SUB_LIST_opcode     17
#define V3D_packet_v33_BRANCH_TO_SUB_LIST_header\
   .opcode                              =     17

struct V3D_packet_v33_BRANCH_TO_SUB_LIST {
   uint32_t                             opcode;
   __gen_address_type                   address;
};

static inline void
V3D_packet_v33_BRANCH_TO_SUB_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D_packet_v33_BRANCH_TO_SUB_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_BRANCH_TO_SUB_LIST_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_BRANCH_TO_SUB_LIST_unpack(const uint8_t * restrict cl,
                                         struct V3D_packet_v33_BRANCH_TO_SUB_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 8, 39);
}
...
#define V3D_packet_v33_RETURN_FROM_SUB_LIST_opcode     18
#define V3D_packet_v33_RETURN_FROM_SUB_LIST_header\
   .opcode                              =     18

struct V3D_packet_v33_RETURN_FROM_SUB_LIST {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_RETURN_FROM_SUB_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                         const struct V3D_packet_v33_RETURN_FROM_SUB_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_RETURN_FROM_SUB_LIST_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_RETURN_FROM_SUB_LIST_unpack(const uint8_t * restrict cl,
                                           struct V3D_packet_v33_RETURN_FROM_SUB_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_FLUSH_VCD_CACHE_opcode     19
#define V3D_packet_v33_FLUSH_VCD_CACHE_header   \
   .opcode                              =     19

struct V3D_packet_v33_FLUSH_VCD_CACHE {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_FLUSH_VCD_CACHE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D_packet_v33_FLUSH_VCD_CACHE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_FLUSH_VCD_CACHE_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_FLUSH_VCD_CACHE_unpack(const uint8_t * restrict cl,
                                      struct V3D_packet_v33_FLUSH_VCD_CACHE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_START_ADDRESS_OF_GENERIC_TILE_LIST_opcode     20
#define V3D_packet_v33_START_ADDRESS_OF_GENERIC_TILE_LIST_header\
   .opcode                              =     20

struct V3D_packet_v33_START_ADDRESS_OF_GENERIC_TILE_LIST {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_START_ADDRESS_OF_GENERIC_TILE_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                       const struct V3D_packet_v33_START_ADDRESS_OF_GENERIC_TILE_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_START_ADDRESS_OF_GENERIC_TILE_LIST_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_START_ADDRESS_OF_GENERIC_TILE_LIST_unpack(const uint8_t * restrict cl,
                                                         struct V3D_packet_v33_START_ADDRESS_OF_GENERIC_TILE_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_BRANCH_TO_IMPLICIT_TILE_LIST_opcode     21
#define V3D_packet_v33_BRANCH_TO_IMPLICIT_TILE_LIST_header\
   .opcode                              =     21

struct V3D_packet_v33_BRANCH_TO_IMPLICIT_TILE_LIST {
   uint32_t                             opcode;
   uint32_t                             tile_list_set_number;
};

static inline void
V3D_packet_v33_BRANCH_TO_IMPLICIT_TILE_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                 const struct V3D_packet_v33_BRANCH_TO_IMPLICIT_TILE_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_BRANCH_TO_IMPLICIT_TILE_LIST_length      2
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_BRANCH_TO_IMPLICIT_TILE_LIST_unpack(const uint8_t * restrict cl,
                                                   struct V3D_packet_v33_BRANCH_TO_IMPLICIT_TILE_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_BRANCH_TO_EXPLICIT_SUPERTILE_opcode     22
#define V3D_packet_v33_BRANCH_TO_EXPLICIT_SUPERTILE_header\
   .opcode                              =     22

struct V3D_packet_v33_BRANCH_TO_EXPLICIT_SUPERTILE {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_BRANCH_TO_EXPLICIT_SUPERTILE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                 const struct V3D_packet_v33_BRANCH_TO_EXPLICIT_SUPERTILE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_BRANCH_TO_EXPLICIT_SUPERTILE_length      8
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_BRANCH_TO_EXPLICIT_SUPERTILE_unpack(const uint8_t * restrict cl,
                                                   struct V3D_packet_v33_BRANCH_TO_EXPLICIT_SUPERTILE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_SUPERTILE_COORDINATES_opcode     23
#define V3D_packet_v33_SUPERTILE_COORDINATES_header\
   .opcode                              =     23

struct V3D_packet_v33_SUPERTILE_COORDINATES {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_SUPERTILE_COORDINATES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                          const struct V3D_packet_v33_SUPERTILE_COORDINATES * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_SUPERTILE_COORDINATES_length      3
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_SUPERTILE_COORDINATES_unpack(const uint8_t * restrict cl,
                                            struct V3D_packet_v33_SUPERTILE_COORDINATES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_CLEAR_TILE_BUFFERS_opcode     25
#define V3D_packet_v33_CLEAR_TILE_BUFFERS_header\
   .opcode                              =     25

struct V3D_packet_v33_CLEAR_TILE_BUFFERS {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_CLEAR_TILE_BUFFERS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D_packet_v33_CLEAR_TILE_BUFFERS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_CLEAR_TILE_BUFFERS_length      2
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_CLEAR_TILE_BUFFERS_unpack(const uint8_t * restrict cl,
                                         struct V3D_packet_v33_CLEAR_TILE_BUFFERS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_END_OF_LOADS_opcode     26
#define V3D_packet_v33_END_OF_LOADS_header      \
   .opcode                              =     26

struct V3D_packet_v33_END_OF_LOADS {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_END_OF_LOADS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                 const struct V3D_packet_v33_END_OF_LOADS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_END_OF_LOADS_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_END_OF_LOADS_unpack(const uint8_t * restrict cl,
                                   struct V3D_packet_v33_END_OF_LOADS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_END_OF_TILE_MARKER_opcode     27
#define V3D_packet_v33_END_OF_TILE_MARKER_header\
   .opcode                              =     27

struct V3D_packet_v33_END_OF_TILE_MARKER {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_END_OF_TILE_MARKER_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D_packet_v33_END_OF_TILE_MARKER * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_END_OF_TILE_MARKER_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_END_OF_TILE_MARKER_unpack(const uint8_t * restrict cl,
                                         struct V3D_packet_v33_END_OF_TILE_MARKER * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_STORE_TILE_BUFFER_GENERAL_opcode     29
#define V3D_packet_v33_STORE_TILE_BUFFER_GENERAL_header\
   .opcode                              =     29

struct V3D_packet_v33_STORE_TILE_BUFFER_GENERAL {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             height;
   ...
   enum V3D_packet_v33_Output_Image_Format output_image_format;
   enum V3D_packet_v33_Decimate_Mode    decimate_mode;
   enum V3D_packet_v33_Dither_Mode      dither_mode;
   bool                                 flip_y;
   enum V3D_packet_v33_Memory_Format    memory_format;
...
static inline void
V3D_packet_v33_STORE_TILE_BUFFER_GENERAL_pack(__gen_user_data *data, uint8_t * restrict cl,
                                              const struct V3D_packet_v33_STORE_TILE_BUFFER_GENERAL * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_STORE_TILE_BUFFER_GENERAL_length     13
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_STORE_TILE_BUFFER_GENERAL_unpack(const uint8_t * restrict cl,
                                                struct V3D_packet_v33_STORE_TILE_BUFFER_GENERAL * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_LOAD_TILE_BUFFER_GENERAL_opcode     30
#define V3D_packet_v33_LOAD_TILE_BUFFER_GENERAL_header\
   .opcode                              =     30

struct V3D_packet_v33_LOAD_TILE_BUFFER_GENERAL {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             height;
   uint32_t                             height_in_ub_or_stride;
   bool                                 r_b_swap;
   bool                                 channel_reverse;
   enum V3D_packet_v33_Output_Image_Format input_image_format;
   enum V3D_packet_v33_Decimate_Mode    decimate_mode;
   bool                                 flip_y;
   enum V3D_packet_v33_Memory_Format    memory_format;
...
static inline void
V3D_packet_v33_LOAD_TILE_BUFFER_GENERAL_pack(__gen_user_data *data, uint8_t * restrict cl,
                                             const struct V3D_packet_v33_LOAD_TILE_BUFFER_GENERAL * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_LOAD_TILE_BUFFER_GENERAL_length     13
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_LOAD_TILE_BUFFER_GENERAL_unpack(const uint8_t * restrict cl,
                                               struct V3D_packet_v33_LOAD_TILE_BUFFER_GENERAL * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 72, 103);
   values->height = __gen_unpack_uint(cl, 56, 71);
...
#define V3D_packet_v33_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT_opcode     31
#define V3D_packet_v33_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT_header\
   .opcode                              =     31

struct V3D_packet_v33_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                       const struct V3D_packet_v33_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT_unpack(const uint8_t * restrict cl,
                                                         struct V3D_packet_v33_TRANSFORM_FEEDBACK_FLUSH_AND_COUNT * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_INDEXED_PRIM_LIST_opcode     32
#define V3D_packet_v33_INDEXED_PRIM_LIST_header \
   .opcode                              =     32

struct V3D_packet_v33_INDEXED_PRIM_LIST {
   uint32_t                             opcode;
...
#define INDEX_TYPE_32_BIT                        2
   enum V3D_packet_v33_Primitive        mode;
};

static inline void
V3D_packet_v33_INDEXED_PRIM_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                      const struct V3D_packet_v33_INDEXED_PRIM_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_INDEXED_PRIM_LIST_length     10
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_INDEXED_PRIM_LIST_unpack(const uint8_t * restrict cl,
                                        struct V3D_packet_v33_INDEXED_PRIM_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_INDIRECT_INDEXED_INSTANCED_PRIM_LIST_opcode     33
#define V3D_packet_v33_INDIRECT_INDEXED_INSTANCED_PRIM_LIST_header\
   .opcode                              =     33

struct V3D_packet_v33_INDIRECT_INDEXED_INSTANCED_PRIM_LIST {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_INDIRECT_INDEXED_INSTANCED_PRIM_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                         const struct V3D_packet_v33_INDIRECT_INDEXED_INSTANCED_PRIM_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_INDIRECT_INDEXED_INSTANCED_PRIM_LIST_length     11
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_INDIRECT_INDEXED_INSTANCED_PRIM_LIST_unpack(const uint8_t * restrict cl,
                                                           struct V3D_packet_v33_INDIRECT_INDEXED_INSTANCED_PRIM_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_INDEXED_INSTANCED_PRIM_LIST_opcode     34
#define V3D_packet_v33_INDEXED_INSTANCED_PRIM_LIST_header\
   .opcode                              =     34

struct V3D_packet_v33_INDEXED_INSTANCED_PRIM_LIST {
   uint32_t                             opcode;
   uint32_t                             index_offset;
...
static inline void
V3D_packet_v33_INDEXED_INSTANCED_PRIM_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                const struct V3D_packet_v33_INDEXED_INSTANCED_PRIM_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_INDEXED_INSTANCED_PRIM_LIST_length     14
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_INDEXED_INSTANCED_PRIM_LIST_unpack(const uint8_t * restrict cl,
                                                  struct V3D_packet_v33_INDEXED_INSTANCED_PRIM_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_VERTEX_ARRAY_PRIMS_opcode     36
#define V3D_packet_v33_VERTEX_ARRAY_PRIMS_header\
   .opcode                              =     36

struct V3D_packet_v33_VERTEX_ARRAY_PRIMS {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_VERTEX_ARRAY_PRIMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D_packet_v33_VERTEX_ARRAY_PRIMS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_VERTEX_ARRAY_PRIMS_length     10
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_VERTEX_ARRAY_PRIMS_unpack(const uint8_t * restrict cl,
                                         struct V3D_packet_v33_VERTEX_ARRAY_PRIMS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS_opcode     37
#define V3D_packet_v33_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS_header\
   .opcode                              =     37

struct V3D_packet_v33_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS {
   uint32_t                             opcode;
   uint32_t                             stride_in_multiples_of_4_bytes;
   __gen_address_type                   address;
...
static inline void
V3D_packet_v33_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                          const struct V3D_packet_v33_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS_length     11
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS_unpack(const uint8_t * restrict cl,
                                                            struct V3D_packet_v33_INDIRECT_VERTEX_ARRAY_INSTANCED_PRIMS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->stride_in_multiples_of_4_bytes = __gen_unpack_uint(cl, 80, 87);
   values->address = __gen_unpack_address(cl, 48, 79);
...
#define V3D_packet_v33_VERTEX_ARRAY_INSTANCED_PRIMS_opcode     38
#define V3D_packet_v33_VERTEX_ARRAY_INSTANCED_PRIMS_header\
   .opcode                              =     38

struct V3D_packet_v33_VERTEX_ARRAY_INSTANCED_PRIMS {
   uint32_t                             opcode;
   uint32_t                             index_of_first_vertex;
   uint32_t                             number_of_instances;
   uint32_t                             instance_length;
...
static inline void
V3D_packet_v33_VERTEX_ARRAY_INSTANCED_PRIMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                 const struct V3D_packet_v33_VERTEX_ARRAY_INSTANCED_PRIMS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_VERTEX_ARRAY_INSTANCED_PRIMS_length     14
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_VERTEX_ARRAY_INSTANCED_PRIMS_unpack(const uint8_t * restrict cl,
                                                   struct V3D_packet_v33_VERTEX_ARRAY_INSTANCED_PRIMS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS_opcode     39
#define V3D_packet_v33_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS_header\
   .opcode                              =     39

struct V3D_packet_v33_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS {
   uint32_t                             opcode;
   uint32_t                             index_of_first_vertex;
...
static inline void
V3D_packet_v33_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                       const struct V3D_packet_v33_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS_length     14
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS_unpack(const uint8_t * restrict cl,
                                                         struct V3D_packet_v33_VERTEX_ARRAY_SINGLE_INSTANCE_PRIMS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->index_of_first_vertex = __gen_unpack_uint(cl, 80, 111);
...
#define V3D_packet_v33_BASE_VERTEX_BASE_INSTANCE_opcode     43
#define V3D_packet_v33_BASE_VERTEX_BASE_INSTANCE_header\
   .opcode                              =     43

struct V3D_packet_v33_BASE_VERTEX_BASE_INSTANCE {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_BASE_VERTEX_BASE_INSTANCE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                              const struct V3D_packet_v33_BASE_VERTEX_BASE_INSTANCE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_BASE_VERTEX_BASE_INSTANCE_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_BASE_VERTEX_BASE_INSTANCE_unpack(const uint8_t * restrict cl,
                                                struct V3D_packet_v33_BASE_VERTEX_BASE_INSTANCE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_INDEX_BUFFER_SETUP_opcode     44
#define V3D_packet_v33_INDEX_BUFFER_SETUP_header\
   .opcode                              =     44

struct V3D_packet_v33_INDEX_BUFFER_SETUP {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             size;
};
...
static inline void
V3D_packet_v33_INDEX_BUFFER_SETUP_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D_packet_v33_INDEX_BUFFER_SETUP * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_INDEX_BUFFER_SETUP_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_INDEX_BUFFER_SETUP_unpack(const uint8_t * restrict cl,
                                         struct V3D_packet_v33_INDEX_BUFFER_SETUP * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 8, 39);
...
#define V3D_packet_v33_SET_INSTANCEID_opcode     54
#define V3D_packet_v33_SET_INSTANCEID_header    \
   .opcode                              =     54

struct V3D_packet_v33_SET_INSTANCEID {
   uint32_t                             opcode;
   uint32_t                             instance_id;
};

static inline void
V3D_packet_v33_SET_INSTANCEID_pack(__gen_user_data *data, uint8_t * restrict cl,
                                   const struct V3D_packet_v33_SET_INSTANCEID * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_SET_INSTANCEID_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_SET_INSTANCEID_unpack(const uint8_t * restrict cl,
                                     struct V3D_packet_v33_SET_INSTANCEID * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_SET_PRIMITIVEID_opcode     55
#define V3D_packet_v33_SET_PRIMITIVEID_header   \
   .opcode                              =     55

struct V3D_packet_v33_SET_PRIMITIVEID {
   uint32_t                             opcode;
   uint32_t                             primitive_id;
};

static inline void
V3D_packet_v33_SET_PRIMITIVEID_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D_packet_v33_SET_PRIMITIVEID * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_SET_PRIMITIVEID_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_SET_PRIMITIVEID_unpack(const uint8_t * restrict cl,
                                      struct V3D_packet_v33_SET_PRIMITIVEID * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_PRIM_LIST_FORMAT_opcode     56
#define V3D_packet_v33_PRIM_LIST_FORMAT_header  \
   .opcode                              =     56

struct V3D_packet_v33_PRIM_LIST_FORMAT {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_PRIM_LIST_FORMAT_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D_packet_v33_PRIM_LIST_FORMAT * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_PRIM_LIST_FORMAT_length      2
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_PRIM_LIST_FORMAT_unpack(const uint8_t * restrict cl,
                                       struct V3D_packet_v33_PRIM_LIST_FORMAT * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_SERIAL_NUMBER_LIST_START_opcode     57
#define V3D_packet_v33_SERIAL_NUMBER_LIST_START_header\
   .opcode                              =     57

struct V3D_packet_v33_SERIAL_NUMBER_LIST_START {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             block_size;
...
static inline void
V3D_packet_v33_SERIAL_NUMBER_LIST_START_pack(__gen_user_data *data, uint8_t * restrict cl,
                                             const struct V3D_packet_v33_SERIAL_NUMBER_LIST_START * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_SERIAL_NUMBER_LIST_START_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_SERIAL_NUMBER_LIST_START_unpack(const uint8_t * restrict cl,
                                               struct V3D_packet_v33_SERIAL_NUMBER_LIST_START * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_GL_SHADER_STATE_opcode     64
#define V3D_packet_v33_GL_SHADER_STATE_header   \
   .opcode                              =     64

struct V3D_packet_v33_GL_SHADER_STATE {
   uint32_t                             opcode;
   __gen_address_type                   address;
...
static inline void
V3D_packet_v33_GL_SHADER_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D_packet_v33_GL_SHADER_STATE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_GL_SHADER_STATE_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_GL_SHADER_STATE_unpack(const uint8_t * restrict cl,
                                      struct V3D_packet_v33_GL_SHADER_STATE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_opcode     65
#define V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_header\
   .opcode                              =     65

struct V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             number_of_attribute_arrays;
};
...
static inline void
V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                 const struct V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_unpack(const uint8_t * restrict cl,
                                                   struct V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 13, 39);
   values->number_of_attribute_arrays = __gen_unpack_uint(cl, 8, 12);
...
#define V3D_packet_v33_GL_SHADER_STATE_INCLUDING_GS_opcode     66
#define V3D_packet_v33_GL_SHADER_STATE_INCLUDING_GS_header\
   .opcode                              =     66

struct V3D_packet_v33_GL_SHADER_STATE_INCLUDING_GS {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             number_of_attribute_arrays;
};
...
static inline void
V3D_packet_v33_GL_SHADER_STATE_INCLUDING_GS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                 const struct V3D_packet_v33_GL_SHADER_STATE_INCLUDING_GS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_GL_SHADER_STATE_INCLUDING_GS_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_GL_SHADER_STATE_INCLUDING_GS_unpack(const uint8_t * restrict cl,
                                                   struct V3D_packet_v33_GL_SHADER_STATE_INCLUDING_GS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 13, 39);
   values->number_of_attribute_arrays = __gen_unpack_uint(cl, 8, 12);
...
#define V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_GS_opcode     67
#define V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_GS_header\
   .opcode                              =     67

struct V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_GS {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             number_of_attribute_arrays;
};
...
static inline void
V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_GS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                    const struct V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_GS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_GS_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_GS_unpack(const uint8_t * restrict cl,
                                                      struct V3D_packet_v33_GL_SHADER_STATE_INCLUDING_TS_GS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 13, 39);
   values->number_of_attribute_arrays = __gen_unpack_uint(cl, 8, 12);
...
#define V3D_packet_v33_VCM_CACHE_SIZE_opcode     71
#define V3D_packet_v33_VCM_CACHE_SIZE_header    \
   .opcode                              =     71

struct V3D_packet_v33_VCM_CACHE_SIZE {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_VCM_CACHE_SIZE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                   const struct V3D_packet_v33_VCM_CACHE_SIZE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_VCM_CACHE_SIZE_length      2
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_VCM_CACHE_SIZE_unpack(const uint8_t * restrict cl,
                                     struct V3D_packet_v33_VCM_CACHE_SIZE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_PRIMITIVE_COUNTS_FEEDBACK_opcode     72
#define V3D_packet_v33_PRIMITIVE_COUNTS_FEEDBACK_header\
   .opcode                              =     72

struct V3D_packet_v33_PRIMITIVE_COUNTS_FEEDBACK {
   uint32_t                             opcode;
   __gen_address_type                   address;
...
static inline void
V3D_packet_v33_PRIMITIVE_COUNTS_FEEDBACK_pack(__gen_user_data *data, uint8_t * restrict cl,
                                              const struct V3D_packet_v33_PRIMITIVE_COUNTS_FEEDBACK * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_PRIMITIVE_COUNTS_FEEDBACK_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_PRIMITIVE_COUNTS_FEEDBACK_unpack(const uint8_t * restrict cl,
                                                struct V3D_packet_v33_PRIMITIVE_COUNTS_FEEDBACK * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 13, 39);
...
#define V3D_packet_v33_TRANSFORM_FEEDBACK_BUFFER_opcode     73
#define V3D_packet_v33_TRANSFORM_FEEDBACK_BUFFER_header\
   .opcode                              =     73

struct V3D_packet_v33_TRANSFORM_FEEDBACK_BUFFER {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_TRANSFORM_FEEDBACK_BUFFER_pack(__gen_user_data *data, uint8_t * restrict cl,
                                              const struct V3D_packet_v33_TRANSFORM_FEEDBACK_BUFFER * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_TRANSFORM_FEEDBACK_BUFFER_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TRANSFORM_FEEDBACK_BUFFER_unpack(const uint8_t * restrict cl,
                                                struct V3D_packet_v33_TRANSFORM_FEEDBACK_BUFFER * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_TRANSFORM_FEEDBACK_SPECS_opcode     74
#define V3D_packet_v33_TRANSFORM_FEEDBACK_SPECS_header\
   .opcode                              =     74

struct V3D_packet_v33_TRANSFORM_FEEDBACK_SPECS {
   uint32_t                             opcode;
   bool                                 enable;
...
static inline void
V3D_packet_v33_TRANSFORM_FEEDBACK_SPECS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                             const struct V3D_packet_v33_TRANSFORM_FEEDBACK_SPECS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_TRANSFORM_FEEDBACK_SPECS_length      2
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TRANSFORM_FEEDBACK_SPECS_unpack(const uint8_t * restrict cl,
                                               struct V3D_packet_v33_TRANSFORM_FEEDBACK_SPECS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_FLUSH_TRANSFORM_FEEDBACK_DATA_opcode     75
#define V3D_packet_v33_FLUSH_TRANSFORM_FEEDBACK_DATA_header\
   .opcode                              =     75

struct V3D_packet_v33_FLUSH_TRANSFORM_FEEDBACK_DATA {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_FLUSH_TRANSFORM_FEEDBACK_DATA_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                  const struct V3D_packet_v33_FLUSH_TRANSFORM_FEEDBACK_DATA * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_FLUSH_TRANSFORM_FEEDBACK_DATA_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_FLUSH_TRANSFORM_FEEDBACK_DATA_unpack(const uint8_t * restrict cl,
                                                    struct V3D_packet_v33_FLUSH_TRANSFORM_FEEDBACK_DATA * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_L1_CACHE_FLUSH_CONTROL_opcode     76
#define V3D_packet_v33_L1_CACHE_FLUSH_CONTROL_header\
   .opcode                              =     76

struct V3D_packet_v33_L1_CACHE_FLUSH_CONTROL {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_L1_CACHE_FLUSH_CONTROL_pack(__gen_user_data *data, uint8_t * restrict cl,
                                           const struct V3D_packet_v33_L1_CACHE_FLUSH_CONTROL * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_L1_CACHE_FLUSH_CONTROL_length      3
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_L1_CACHE_FLUSH_CONTROL_unpack(const uint8_t * restrict cl,
                                             struct V3D_packet_v33_L1_CACHE_FLUSH_CONTROL * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_L2T_CACHE_FLUSH_CONTROL_opcode     77
#define V3D_packet_v33_L2T_CACHE_FLUSH_CONTROL_header\
   .opcode                              =     77

struct V3D_packet_v33_L2T_CACHE_FLUSH_CONTROL {
   uint32_t                             opcode;
   enum V3D_packet_v33_L2T_Flush_Mode   l2t_flush_mode;
   __gen_address_type                   l2t_flush_end;
   __gen_address_type                   l2t_flush_start;
};

static inline void
V3D_packet_v33_L2T_CACHE_FLUSH_CONTROL_pack(__gen_user_data *data, uint8_t * restrict cl,
                                            const struct V3D_packet_v33_L2T_CACHE_FLUSH_CONTROL * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_L2T_CACHE_FLUSH_CONTROL_length     10
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_L2T_CACHE_FLUSH_CONTROL_unpack(const uint8_t * restrict cl,
                                              struct V3D_packet_v33_L2T_CACHE_FLUSH_CONTROL * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC_header\


struct V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC {
...
static inline void
V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                        const struct V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC * restrict values)
{
...
#define V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC_length      2
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC_unpack(const uint8_t * restrict cl,
                                                          struct V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_DATA_SPEC * restrict values)
{
...
#define V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS_header\


struct V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS {
   __gen_address_type                   address;
};

static inline void
V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                      const struct V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS * restrict values)
{
   __gen_emit_reloc(data, &values->address);
...
#define V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS_length      4
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS_unpack(const uint8_t * restrict cl,
                                                        struct V3D_packet_v33_TRANSFORM_FEEDBACK_OUTPUT_ADDRESS * restrict values)
{
...
#define V3D_packet_v33_STENCIL_CFG_opcode     80
#define V3D_packet_v33_STENCIL_CFG_header       \
   .opcode                              =     80

struct V3D_packet_v33_STENCIL_CFG {
   uint32_t                             opcode;
   uint32_t                             stencil_write_mask;
   bool                                 back_config;
   bool                                 front_config;
   enum V3D_packet_v33_Stencil_Op       stencil_pass_op;
   enum V3D_packet_v33_Stencil_Op       depth_test_fail_op;
   enum V3D_packet_v33_Stencil_Op       stencil_test_fail_op;
   enum V3D_packet_v33_Compare_Function stencil_test_function;
   uint32_t                             stencil_test_mask;
   uint32_t                             stencil_ref_value;
};

static inline void
V3D_packet_v33_STENCIL_CFG_pack(__gen_user_data *data, uint8_t * restrict cl,
                                const struct V3D_packet_v33_STENCIL_CFG * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_STENCIL_CFG_length      6
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_STENCIL_CFG_unpack(const uint8_t * restrict cl,
                                  struct V3D_packet_v33_STENCIL_CFG * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_BLEND_ENABLES_opcode     83
#define V3D_packet_v33_BLEND_ENABLES_header     \
   .opcode                              =     83

struct V3D_packet_v33_BLEND_ENABLES {
   uint32_t                             opcode;
   uint32_t                             mask;
};

static inline void
V3D_packet_v33_BLEND_ENABLES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                  const struct V3D_packet_v33_BLEND_ENABLES * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_BLEND_ENABLES_length      2
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_BLEND_ENABLES_unpack(const uint8_t * restrict cl,
                                    struct V3D_packet_v33_BLEND_ENABLES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_BLEND_CFG_opcode       84
#define V3D_packet_v33_BLEND_CFG_header         \
   .opcode                              =     84

struct V3D_packet_v33_BLEND_CFG {
   uint32_t                             opcode;
   uint32_t                             render_target_mask;
   enum V3D_packet_v33_Blend_Factor     color_blend_dst_factor;
   enum V3D_packet_v33_Blend_Factor     color_blend_src_factor;
   enum V3D_packet_v33_Blend_Mode       color_blend_mode;
   enum V3D_packet_v33_Blend_Factor     alpha_blend_dst_factor;
   enum V3D_packet_v33_Blend_Factor     alpha_blend_src_factor;
   enum V3D_packet_v33_Blend_Mode       alpha_blend_mode;
};

static inline void
V3D_packet_v33_BLEND_CFG_pack(__gen_user_data *data, uint8_t * restrict cl,
                              const struct V3D_packet_v33_BLEND_CFG * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_BLEND_CFG_length        5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_BLEND_CFG_unpack(const uint8_t * restrict cl,
                                struct V3D_packet_v33_BLEND_CFG * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_BLEND_CONSTANT_COLOR_opcode     86
#define V3D_packet_v33_BLEND_CONSTANT_COLOR_header\
   .opcode                              =     86

struct V3D_packet_v33_BLEND_CONSTANT_COLOR {
   uint32_t                             opcode;
   uint32_t                             alpha_f16;
   uint32_t                             blue_f16;
   uint32_t                             green_f16;
...
static inline void
V3D_packet_v33_BLEND_CONSTANT_COLOR_pack(__gen_user_data *data, uint8_t * restrict cl,
                                         const struct V3D_packet_v33_BLEND_CONSTANT_COLOR * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_BLEND_CONSTANT_COLOR_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_BLEND_CONSTANT_COLOR_unpack(const uint8_t * restrict cl,
                                           struct V3D_packet_v33_BLEND_CONSTANT_COLOR * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_COLOR_WRITE_MASKS_opcode     87
#define V3D_packet_v33_COLOR_WRITE_MASKS_header \
   .opcode                              =     87

struct V3D_packet_v33_COLOR_WRITE_MASKS {
   uint32_t                             opcode;
   uint32_t                             mask;
};

static inline void
V3D_packet_v33_COLOR_WRITE_MASKS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                      const struct V3D_packet_v33_COLOR_WRITE_MASKS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_COLOR_WRITE_MASKS_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_COLOR_WRITE_MASKS_unpack(const uint8_t * restrict cl,
                                        struct V3D_packet_v33_COLOR_WRITE_MASKS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_ZERO_ALL_CENTROID_FLAGS_opcode     88
#define V3D_packet_v33_ZERO_ALL_CENTROID_FLAGS_header\
   .opcode                              =     88

struct V3D_packet_v33_ZERO_ALL_CENTROID_FLAGS {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_ZERO_ALL_CENTROID_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                            const struct V3D_packet_v33_ZERO_ALL_CENTROID_FLAGS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_ZERO_ALL_CENTROID_FLAGS_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_ZERO_ALL_CENTROID_FLAGS_unpack(const uint8_t * restrict cl,
                                              struct V3D_packet_v33_ZERO_ALL_CENTROID_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_CENTROID_FLAGS_opcode     89
#define V3D_packet_v33_CENTROID_FLAGS_header    \
   .opcode                              =     89

struct V3D_packet_v33_CENTROID_FLAGS {
   uint32_t                             opcode;
   uint32_t                             centroid_flags_for_varyings_v024;
   enum V3D_packet_v33_Varying_Flags_Action action_for_centroid_flags_of_higher_numbered_varyings;
   enum V3D_packet_v33_Varying_Flags_Action action_for_centroid_flags_of_lower_numbered_varyings;
   uint32_t                             varying_offset_v0;
};

static inline void
V3D_packet_v33_CENTROID_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                   const struct V3D_packet_v33_CENTROID_FLAGS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_CENTROID_FLAGS_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_CENTROID_FLAGS_unpack(const uint8_t * restrict cl,
                                     struct V3D_packet_v33_CENTROID_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_SAMPLE_STATE_opcode     91
#define V3D_packet_v33_SAMPLE_STATE_header      \
   .opcode                              =     91

struct V3D_packet_v33_SAMPLE_STATE {
   uint32_t                             opcode;
   float                                coverage;
   uint32_t                             mask;
};
...
static inline void
V3D_packet_v33_SAMPLE_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                 const struct V3D_packet_v33_SAMPLE_STATE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_SAMPLE_STATE_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_SAMPLE_STATE_unpack(const uint8_t * restrict cl,
                                   struct V3D_packet_v33_SAMPLE_STATE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_OCCLUSION_QUERY_COUNTER_opcode     92
#define V3D_packet_v33_OCCLUSION_QUERY_COUNTER_header\
   .opcode                              =     92

struct V3D_packet_v33_OCCLUSION_QUERY_COUNTER {
   uint32_t                             opcode;
   __gen_address_type                   address;
};

static inline void
V3D_packet_v33_OCCLUSION_QUERY_COUNTER_pack(__gen_user_data *data, uint8_t * restrict cl,
                                            const struct V3D_packet_v33_OCCLUSION_QUERY_COUNTER * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_OCCLUSION_QUERY_COUNTER_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_OCCLUSION_QUERY_COUNTER_unpack(const uint8_t * restrict cl,
                                              struct V3D_packet_v33_OCCLUSION_QUERY_COUNTER * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 8, 39);
}
...
#define V3D_packet_v33_CFG_BITS_opcode        96
#define V3D_packet_v33_CFG_BITS_header          \
   .opcode                              =     96

struct V3D_packet_v33_CFG_BITS {
   uint32_t                             opcode;
   ...
   enum V3D_packet_v33_Compare_Function depth_test_function;
...
static inline void
V3D_packet_v33_CFG_BITS_pack(__gen_user_data *data, uint8_t * restrict cl,
                             const struct V3D_packet_v33_CFG_BITS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_CFG_BITS_length         4
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_CFG_BITS_unpack(const uint8_t * restrict cl,
                               struct V3D_packet_v33_CFG_BITS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_ZERO_ALL_FLAT_SHADE_FLAGS_opcode     97
#define V3D_packet_v33_ZERO_ALL_FLAT_SHADE_FLAGS_header\
   .opcode                              =     97

struct V3D_packet_v33_ZERO_ALL_FLAT_SHADE_FLAGS {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_ZERO_ALL_FLAT_SHADE_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                              const struct V3D_packet_v33_ZERO_ALL_FLAT_SHADE_FLAGS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_ZERO_ALL_FLAT_SHADE_FLAGS_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_ZERO_ALL_FLAT_SHADE_FLAGS_unpack(const uint8_t * restrict cl,
                                                struct V3D_packet_v33_ZERO_ALL_FLAT_SHADE_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_FLAT_SHADE_FLAGS_opcode     98
#define V3D_packet_v33_FLAT_SHADE_FLAGS_header  \
   .opcode                              =     98

struct V3D_packet_v33_FLAT_SHADE_FLAGS {
   uint32_t                             opcode;
   uint32_t                             flat_shade_flags_for_varyings_v024;
   enum V3D_packet_v33_Varying_Flags_Action action_for_flat_shade_flags_of_higher_numbered_varyings;
   enum V3D_packet_v33_Varying_Flags_Action action_for_flat_shade_flags_of_lower_numbered_varyings;
   uint32_t                             varying_offset_v0;
};

static inline void
V3D_packet_v33_FLAT_SHADE_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D_packet_v33_FLAT_SHADE_FLAGS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_FLAT_SHADE_FLAGS_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_FLAT_SHADE_FLAGS_unpack(const uint8_t * restrict cl,
                                       struct V3D_packet_v33_FLAT_SHADE_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_ZERO_ALL_NON_PERSPECTIVE_FLAGS_opcode     99
#define V3D_packet_v33_ZERO_ALL_NON_PERSPECTIVE_FLAGS_header\
   .opcode                              =     99

struct V3D_packet_v33_ZERO_ALL_NON_PERSPECTIVE_FLAGS {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_ZERO_ALL_NON_PERSPECTIVE_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                   const struct V3D_packet_v33_ZERO_ALL_NON_PERSPECTIVE_FLAGS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_ZERO_ALL_NON_PERSPECTIVE_FLAGS_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_ZERO_ALL_NON_PERSPECTIVE_FLAGS_unpack(const uint8_t * restrict cl,
                                                     struct V3D_packet_v33_ZERO_ALL_NON_PERSPECTIVE_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_NON_PERSPECTIVE_FLAGS_opcode    100
#define V3D_packet_v33_NON_PERSPECTIVE_FLAGS_header\
   .opcode                              =    100

struct V3D_packet_v33_NON_PERSPECTIVE_FLAGS {
   uint32_t                             opcode;
   uint32_t                             non_perspective_flags_for_varyings_v024;
   enum V3D_packet_v33_Varying_Flags_Action action_for_non_perspective_flags_of_higher_numbered_varyings;
   enum V3D_packet_v33_Varying_Flags_Action action_for_non_perspective_flags_of_lower_numbered_varyings;
   uint32_t                             varying_offset_v0;
};

static inline void
V3D_packet_v33_NON_PERSPECTIVE_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                          const struct V3D_packet_v33_NON_PERSPECTIVE_FLAGS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_NON_PERSPECTIVE_FLAGS_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_NON_PERSPECTIVE_FLAGS_unpack(const uint8_t * restrict cl,
                                            struct V3D_packet_v33_NON_PERSPECTIVE_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_POINT_SIZE_opcode     104
#define V3D_packet_v33_POINT_SIZE_header        \
   .opcode                              =    104

struct V3D_packet_v33_POINT_SIZE {
   uint32_t                             opcode;
   float                                point_size;
};

static inline void
V3D_packet_v33_POINT_SIZE_pack(__gen_user_data *data, uint8_t * restrict cl,
                               const struct V3D_packet_v33_POINT_SIZE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_POINT_SIZE_length       5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_POINT_SIZE_unpack(const uint8_t * restrict cl,
                                 struct V3D_packet_v33_POINT_SIZE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_LINE_WIDTH_opcode     105
#define V3D_packet_v33_LINE_WIDTH_header        \
   .opcode                              =    105

struct V3D_packet_v33_LINE_WIDTH {
   uint32_t                             opcode;
   float                                line_width;
};

static inline void
V3D_packet_v33_LINE_WIDTH_pack(__gen_user_data *data, uint8_t * restrict cl,
                               const struct V3D_packet_v33_LINE_WIDTH * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_LINE_WIDTH_length       5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_LINE_WIDTH_unpack(const uint8_t * restrict cl,
                                 struct V3D_packet_v33_LINE_WIDTH * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_DEPTH_OFFSET_opcode    106
#define V3D_packet_v33_DEPTH_OFFSET_header      \
   .opcode                              =    106

struct V3D_packet_v33_DEPTH_OFFSET {
   uint32_t                             opcode;
   float                                limit;
...
static inline void
V3D_packet_v33_DEPTH_OFFSET_pack(__gen_user_data *data, uint8_t * restrict cl,
                                 const struct V3D_packet_v33_DEPTH_OFFSET * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_DEPTH_OFFSET_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_DEPTH_OFFSET_unpack(const uint8_t * restrict cl,
                                   struct V3D_packet_v33_DEPTH_OFFSET * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_CLIP_WINDOW_opcode    107
#define V3D_packet_v33_CLIP_WINDOW_header       \
   .opcode                              =    107

struct V3D_packet_v33_CLIP_WINDOW {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_CLIP_WINDOW_pack(__gen_user_data *data, uint8_t * restrict cl,
                                const struct V3D_packet_v33_CLIP_WINDOW * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_CLIP_WINDOW_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_CLIP_WINDOW_unpack(const uint8_t * restrict cl,
                                  struct V3D_packet_v33_CLIP_WINDOW * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_VIEWPORT_OFFSET_opcode    108
#define V3D_packet_v33_VIEWPORT_OFFSET_header   \
   .opcode                              =    108

struct V3D_packet_v33_VIEWPORT_OFFSET {
   uint32_t                             opcode;
   uint32_t                             coarse_y;
...
static inline void
V3D_packet_v33_VIEWPORT_OFFSET_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D_packet_v33_VIEWPORT_OFFSET * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_VIEWPORT_OFFSET_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_VIEWPORT_OFFSET_unpack(const uint8_t * restrict cl,
                                      struct V3D_packet_v33_VIEWPORT_OFFSET * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES_opcode    109
#define V3D_packet_v33_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES_header\
   .opcode                              =    109

struct V3D_packet_v33_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES {
   uint32_t                             opcode;
   float                                maximum_zw;
   float                                minimum_zw;
};
...
static inline void
V3D_packet_v33_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                      const struct V3D_packet_v33_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES_unpack(const uint8_t * restrict cl,
                                                        struct V3D_packet_v33_CLIPPER_Z_MIN_MAX_CLIPPING_PLANES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_CLIPPER_XY_SCALING_opcode    110
#define V3D_packet_v33_CLIPPER_XY_SCALING_header\
   .opcode                              =    110

struct V3D_packet_v33_CLIPPER_XY_SCALING {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_CLIPPER_XY_SCALING_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D_packet_v33_CLIPPER_XY_SCALING * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_CLIPPER_XY_SCALING_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_CLIPPER_XY_SCALING_unpack(const uint8_t * restrict cl,
                                         struct V3D_packet_v33_CLIPPER_XY_SCALING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_CLIPPER_Z_SCALE_AND_OFFSET_opcode    111
#define V3D_packet_v33_CLIPPER_Z_SCALE_AND_OFFSET_header\
   .opcode                              =    111

struct V3D_packet_v33_CLIPPER_Z_SCALE_AND_OFFSET {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_CLIPPER_Z_SCALE_AND_OFFSET_pack(__gen_user_data *data, uint8_t * restrict cl,
                                               const struct V3D_packet_v33_CLIPPER_Z_SCALE_AND_OFFSET * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_CLIPPER_Z_SCALE_AND_OFFSET_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_CLIPPER_Z_SCALE_AND_OFFSET_unpack(const uint8_t * restrict cl,
                                                 struct V3D_packet_v33_CLIPPER_Z_SCALE_AND_OFFSET * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_NUMBER_OF_LAYERS_opcode    119
#define V3D_packet_v33_NUMBER_OF_LAYERS_header  \
   .opcode                              =    119

struct V3D_packet_v33_NUMBER_OF_LAYERS {
   uint32_t                             opcode;
   uint32_t                             number_of_layers;
};

static inline void
V3D_packet_v33_NUMBER_OF_LAYERS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D_packet_v33_NUMBER_OF_LAYERS * restrict values)
{
...
#define V3D_packet_v33_NUMBER_OF_LAYERS_length      2
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_NUMBER_OF_LAYERS_unpack(const uint8_t * restrict cl,
                                       struct V3D_packet_v33_NUMBER_OF_LAYERS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_TILE_BINNING_MODE_CFG_opcode    120
#define V3D_packet_v33_TILE_BINNING_MODE_CFG_header\
   .opcode                              =    120

struct V3D_packet_v33_TILE_BINNING_MODE_CFG {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_TILE_BINNING_MODE_CFG_pack(__gen_user_data *data, uint8_t * restrict cl,
                                          const struct V3D_packet_v33_TILE_BINNING_MODE_CFG * restrict values)
{
...
#define V3D_packet_v33_TILE_BINNING_MODE_CFG_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TILE_BINNING_MODE_CFG_unpack(const uint8_t * restrict cl,
                                            struct V3D_packet_v33_TILE_BINNING_MODE_CFG * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_COMMON_opcode    121
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_COMMON_header\
   .opcode                              =    121,  \
   .sub_id                              =      0

struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_COMMON {
   uint32_t                             opcode;
   uint32_t                             pad;
   bool                                 early_depth_stencil_clear;
   enum V3D_packet_v33_Internal_Depth_Type internal_depth_type;
...
#define EARLY_Z_DIRECTION_GT_GE                  1
   bool                                 double_buffer_in_non_ms_mode;
   bool                                 multisample_mode_4x;
   enum V3D_packet_v33_Internal_BPP     maximum_bpp_of_all_render_targets;
...
static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_COMMON_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                   const struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_COMMON * restrict values)
{
   assert(values->number_of_render_targets >= 1);
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_COMMON_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_COMMON_unpack(const uint8_t * restrict cl,
                                                     struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_COMMON * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_COLOR_opcode    121
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_COLOR_header\
   .opcode                              =    121,  \
   .sub_id                              =      1

struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_COLOR {
   uint32_t                             opcode;
   uint32_t                             pad;
   enum V3D_packet_v33_Render_Target_Clamp render_target_3_clamp;
   enum V3D_packet_v33_Internal_Type    render_target_3_internal_type;
   enum V3D_packet_v33_Internal_BPP     render_target_3_internal_bpp;
   enum V3D_packet_v33_Render_Target_Clamp render_target_2_clamp;
   enum V3D_packet_v33_Internal_Type    render_target_2_internal_type;
   enum V3D_packet_v33_Internal_BPP     render_target_2_internal_bpp;
   enum V3D_packet_v33_Render_Target_Clamp render_target_1_clamp;
   enum V3D_packet_v33_Internal_Type    render_target_1_internal_type;
   enum V3D_packet_v33_Internal_BPP     render_target_1_internal_bpp;
   enum V3D_packet_v33_Render_Target_Clamp render_target_0_clamp;
   enum V3D_packet_v33_Internal_Type    render_target_0_internal_type;
   enum V3D_packet_v33_Internal_BPP     render_target_0_internal_bpp;
   uint32_t                             sub_id;
};

static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_COLOR_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                  const struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_COLOR * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_COLOR_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_COLOR_unpack(const uint8_t * restrict cl,
                                                    struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_COLOR * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES_opcode    121
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES_header\
   .opcode                              =    121,  \
   .sub_id                              =      2

struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES {
   uint32_t                             opcode;
   uint32_t                             unused;
   float                                z_clear_value;
...
static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                            const struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES_unpack(const uint8_t * restrict cl,
                                                              struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_ZS_CLEAR_VALUES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART1_opcode    121
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART1_header\
   .opcode                              =    121,  \
   .sub_id                              =      3

struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART1 {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART1_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                               const struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART1 * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART1_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART1_unpack(const uint8_t * restrict cl,
                                                                 struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART1 * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART2_opcode    121
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART2_header\
   .opcode                              =    121,  \
   .sub_id                              =      4

struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART2 {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART2_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                               const struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART2 * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART2_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART2_unpack(const uint8_t * restrict cl,
                                                                 struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART2 * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART3_opcode    121
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART3_header\
   .opcode                              =    121,  \
   .sub_id                              =      5

struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART3 {
   uint32_t                             opcode;
   uint32_t                             pad;
...
static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART3_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                               const struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART3 * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART3_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART3_unpack(const uint8_t * restrict cl,
                                                                 struct V3D_packet_v33_TILE_RENDERING_MODE_CFG_CLEAR_COLORS_PART3 * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_TILE_COORDINATES_opcode    124
#define V3D_packet_v33_TILE_COORDINATES_header  \
   .opcode                              =    124

struct V3D_packet_v33_TILE_COORDINATES {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_TILE_COORDINATES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D_packet_v33_TILE_COORDINATES * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_TILE_COORDINATES_length      4
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TILE_COORDINATES_unpack(const uint8_t * restrict cl,
                                       struct V3D_packet_v33_TILE_COORDINATES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_MULTICORE_RENDERING_SUPERTILE_CFG_opcode    122
#define V3D_packet_v33_MULTICORE_RENDERING_SUPERTILE_CFG_header\
   .opcode                              =    122

struct V3D_packet_v33_MULTICORE_RENDERING_SUPERTILE_CFG {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_MULTICORE_RENDERING_SUPERTILE_CFG_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                      const struct V3D_packet_v33_MULTICORE_RENDERING_SUPERTILE_CFG * restrict values)
{
...
#define V3D_packet_v33_MULTICORE_RENDERING_SUPERTILE_CFG_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_MULTICORE_RENDERING_SUPERTILE_CFG_unpack(const uint8_t * restrict cl,
                                                        struct V3D_packet_v33_MULTICORE_RENDERING_SUPERTILE_CFG * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_MULTICORE_RENDERING_TILE_LIST_SET_BASE_opcode    123
#define V3D_packet_v33_MULTICORE_RENDERING_TILE_LIST_SET_BASE_header\
   .opcode                              =    123

struct V3D_packet_v33_MULTICORE_RENDERING_TILE_LIST_SET_BASE {
   uint32_t                             opcode;
   __gen_address_type                   address;
   uint32_t                             tile_list_set_number;
};
...
static inline void
V3D_packet_v33_MULTICORE_RENDERING_TILE_LIST_SET_BASE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                           const struct V3D_packet_v33_MULTICORE_RENDERING_TILE_LIST_SET_BASE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_MULTICORE_RENDERING_TILE_LIST_SET_BASE_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_MULTICORE_RENDERING_TILE_LIST_SET_BASE_unpack(const uint8_t * restrict cl,
                                                             struct V3D_packet_v33_MULTICORE_RENDERING_TILE_LIST_SET_BASE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 14, 39);
...
#define V3D_packet_v33_TILE_COORDINATES_IMPLICIT_opcode    125
#define V3D_packet_v33_TILE_COORDINATES_IMPLICIT_header\
   .opcode                              =    125

struct V3D_packet_v33_TILE_COORDINATES_IMPLICIT {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v33_TILE_COORDINATES_IMPLICIT_pack(__gen_user_data *data, uint8_t * restrict cl,
                                              const struct V3D_packet_v33_TILE_COORDINATES_IMPLICIT * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v33_TILE_COORDINATES_IMPLICIT_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TILE_COORDINATES_IMPLICIT_unpack(const uint8_t * restrict cl,
                                                struct V3D_packet_v33_TILE_COORDINATES_IMPLICIT * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v33_TILE_LIST_INITIAL_BLOCK_SIZE_opcode    126
#define V3D_packet_v33_TILE_LIST_INITIAL_BLOCK_SIZE_header\
   .opcode                              =    126

struct V3D_packet_v33_TILE_LIST_INITIAL_BLOCK_SIZE {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v33_TILE_LIST_INITIAL_BLOCK_SIZE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                 const struct V3D_packet_v33_TILE_LIST_INITIAL_BLOCK_SIZE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v33_TILE_LIST_INITIAL_BLOCK_SIZE_length      2
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TILE_LIST_INITIAL_BLOCK_SIZE_unpack(const uint8_t * restrict cl,
                                                   struct V3D_packet_v33_TILE_LIST_INITIAL_BLOCK_SIZE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v33_GL_SHADER_STATE_RECORD_header\


struct V3D_packet_v33_GL_SHADER_STATE_RECORD {
...
static inline void
V3D_packet_v33_GL_SHADER_STATE_RECORD_pack(__gen_user_data *data, uint8_t * restrict cl,
                                           const struct V3D_packet_v33_GL_SHADER_STATE_RECORD * restrict values)
{
...
#define V3D_packet_v33_GL_SHADER_STATE_RECORD_length     36
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_GL_SHADER_STATE_RECORD_unpack(const uint8_t * restrict cl,
                                             struct V3D_packet_v33_GL_SHADER_STATE_RECORD * restrict values)
{
...
#define V3D_packet_v33_GEOMETRY_SHADER_STATE_RECORD_header\


struct V3D_packet_v33_GEOMETRY_SHADER_STATE_RECORD {
...
static inline void
V3D_packet_v33_GEOMETRY_SHADER_STATE_RECORD_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                 const struct V3D_packet_v33_GEOMETRY_SHADER_STATE_RECORD * restrict values)
{
...
#define V3D_packet_v33_GEOMETRY_SHADER_STATE_RECORD_length     16
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_GEOMETRY_SHADER_STATE_RECORD_unpack(const uint8_t * restrict cl,
                                                   struct V3D_packet_v33_GEOMETRY_SHADER_STATE_RECORD * restrict values)
{
...
#define V3D_packet_v33_TESSELLATION_SHADER_STATE_RECORD_header\


struct V3D_packet_v33_TESSELLATION_SHADER_STATE_RECORD {
...
static inline void
V3D_packet_v33_TESSELLATION_SHADER_STATE_RECORD_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                     const struct V3D_packet_v33_TESSELLATION_SHADER_STATE_RECORD * restrict values)
{
...
#define V3D_packet_v33_TESSELLATION_SHADER_STATE_RECORD_length     32
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TESSELLATION_SHADER_STATE_RECORD_unpack(const uint8_t * restrict cl,
                                                       struct V3D_packet_v33_TESSELLATION_SHADER_STATE_RECORD * restrict values)
{
...
#define V3D_packet_v33_TESSELLATION_GEOMETRY_COMMON_PARAMS_header\


struct V3D_packet_v33_TESSELLATION_GEOMETRY_COMMON_PARAMS {
...
static inline void
V3D_packet_v33_TESSELLATION_GEOMETRY_COMMON_PARAMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                        const struct V3D_packet_v33_TESSELLATION_GEOMETRY_COMMON_PARAMS * restrict values)
{
...
#define V3D_packet_v33_TESSELLATION_GEOMETRY_COMMON_PARAMS_length      3
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TESSELLATION_GEOMETRY_COMMON_PARAMS_unpack(const uint8_t * restrict cl,
                                                          struct V3D_packet_v33_TESSELLATION_GEOMETRY_COMMON_PARAMS * restrict values)
{
...
#define V3D_packet_v33_TESSELLATION_GEOMETRY_SHADER_PARAMS_header\


struct V3D_packet_v33_TESSELLATION_GEOMETRY_SHADER_PARAMS {
   enum V3D_packet_v33_TCS_flush_mode   tcs_batch_flush_mode;
   uint32_t                             per_patch_data_column_depth;
   uint32_t                             tcs_output_segment_size_in_sectors;
   enum V3D_packet_v33_Pack_Mode        tcs_output_segment_pack_mode;
   uint32_t                             tes_output_segment_size_in_sectors;
   enum V3D_packet_v33_Pack_Mode        tes_output_segment_pack_mode;
   uint32_t                             gs_output_segment_size_in_sectors;
   enum V3D_packet_v33_Pack_Mode        gs_output_segment_pack_mode;
...
static inline void
V3D_packet_v33_TESSELLATION_GEOMETRY_SHADER_PARAMS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                        const struct V3D_packet_v33_TESSELLATION_GEOMETRY_SHADER_PARAMS * restrict values)
{
...
#define V3D_packet_v33_TESSELLATION_GEOMETRY_SHADER_PARAMS_length      8
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TESSELLATION_GEOMETRY_SHADER_PARAMS_unpack(const uint8_t * restrict cl,
                                                          struct V3D_packet_v33_TESSELLATION_GEOMETRY_SHADER_PARAMS * restrict values)
{
...
#define V3D_packet_v33_GL_SHADER_STATE_ATTRIBUTE_RECORD_header\


struct V3D_packet_v33_GL_SHADER_STATE_ATTRIBUTE_RECORD {
   __gen_address_type                   address;
   uint32_t                             vec_size;
   uint32_t                             type;
...
static inline void
V3D_packet_v33_GL_SHADER_STATE_ATTRIBUTE_RECORD_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                     const struct V3D_packet_v33_GL_SHADER_STATE_ATTRIBUTE_RECORD * restrict values)
{
   __gen_emit_reloc(data, &values->address);
   cl[ 0] = __gen_address_offset(&values->address);
...
#define V3D_packet_v33_GL_SHADER_STATE_ATTRIBUTE_RECORD_length     16
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_GL_SHADER_STATE_ATTRIBUTE_RECORD_unpack(const uint8_t * restrict cl,
                                                       struct V3D_packet_v33_GL_SHADER_STATE_ATTRIBUTE_RECORD * restrict values)
{
   values->address = __gen_unpack_address(cl, 0, 31);
...
#define V3D_packet_v33_VPM_GENERIC_BLOCK_WRITE_SETUP_header\
   .id                                  =      0,  \
   .id0                                 =      0

struct V3D_packet_v33_VPM_GENERIC_BLOCK_WRITE_SETUP {
   uint32_t                             id;
   uint32_t                             id0;
   bool                                 horiz;
   bool                                 laned;
...
static inline void
V3D_packet_v33_VPM_GENERIC_BLOCK_WRITE_SETUP_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                  const struct V3D_packet_v33_VPM_GENERIC_BLOCK_WRITE_SETUP * restrict values)
{
...
#define V3D_packet_v33_VPM_GENERIC_BLOCK_WRITE_SETUP_length      4
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_VPM_GENERIC_BLOCK_WRITE_SETUP_unpack(const uint8_t * restrict cl,
                                                    struct V3D_packet_v33_VPM_GENERIC_BLOCK_WRITE_SETUP * restrict values)
{
...
#define V3D_packet_v33_VPM_GENERIC_BLOCK_READ_SETUP_header\
   .id                                  =      1

struct V3D_packet_v33_VPM_GENERIC_BLOCK_READ_SETUP {
   uint32_t                             id;
   bool                                 horiz;
   bool                                 laned;
   bool                                 segs;
...
static inline void
V3D_packet_v33_VPM_GENERIC_BLOCK_READ_SETUP_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                 const struct V3D_packet_v33_VPM_GENERIC_BLOCK_READ_SETUP * restrict values)
{
   cl[ 0] = __gen_uint(values->addr, 0, 12);
...
#define V3D_packet_v33_VPM_GENERIC_BLOCK_READ_SETUP_length      4
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_VPM_GENERIC_BLOCK_READ_SETUP_unpack(const uint8_t * restrict cl,
                                                   struct V3D_packet_v33_VPM_GENERIC_BLOCK_READ_SETUP * restrict values)
{
   values->id = __gen_unpack_uint(cl, 30, 31);
...
#define V3D_packet_v33_TMU_CONFIG_PARAMETER_0_header\


struct V3D_packet_v33_TMU_CONFIG_PARAMETER_0 {
   __gen_address_type                   texture_state_address;
   uint32_t                             return_words_of_texture_data;
};

static inline void
V3D_packet_v33_TMU_CONFIG_PARAMETER_0_pack(__gen_user_data *data, uint8_t * restrict cl,
                                           const struct V3D_packet_v33_TMU_CONFIG_PARAMETER_0 * restrict values)
{
...
#define V3D_packet_v33_TMU_CONFIG_PARAMETER_0_length      4
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TMU_CONFIG_PARAMETER_0_unpack(const uint8_t * restrict cl,
                                             struct V3D_packet_v33_TMU_CONFIG_PARAMETER_0 * restrict values)
{
...
#define V3D_packet_v33_TMU_CONFIG_PARAMETER_1_header\


struct V3D_packet_v33_TMU_CONFIG_PARAMETER_1 {
...
static inline void
V3D_packet_v33_TMU_CONFIG_PARAMETER_1_pack(__gen_user_data *data, uint8_t * restrict cl,
                                           const struct V3D_packet_v33_TMU_CONFIG_PARAMETER_1 * restrict values)
{
...
#define V3D_packet_v33_TMU_CONFIG_PARAMETER_1_length      4
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TMU_CONFIG_PARAMETER_1_unpack(const uint8_t * restrict cl,
                                             struct V3D_packet_v33_TMU_CONFIG_PARAMETER_1 * restrict values)
{
...
#define V3D_packet_v33_TMU_CONFIG_PARAMETER_2_header\


struct V3D_packet_v33_TMU_CONFIG_PARAMETER_2 {
   uint32_t                             pad;
   bool                                 lod_query;
   enum V3D_packet_v33_TMU_Op           op;
   int32_t                              offset_r;
   int32_t                              offset_t;
   int32_t                              offset_s;
   bool                                 gather_mode;
...
static inline void
V3D_packet_v33_TMU_CONFIG_PARAMETER_2_pack(__gen_user_data *data, uint8_t * restrict cl,
                                           const struct V3D_packet_v33_TMU_CONFIG_PARAMETER_2 * restrict values)
{
...
#define V3D_packet_v33_TMU_CONFIG_PARAMETER_2_length      4
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TMU_CONFIG_PARAMETER_2_unpack(const uint8_t * restrict cl,
                                             struct V3D_packet_v33_TMU_CONFIG_PARAMETER_2 * restrict values)
{
...
#define V3D_packet_v33_TEXTURE_SHADER_STATE_header\


struct V3D_packet_v33_TEXTURE_SHADER_STATE {
   uint64_t                             pad;
...
static inline void
V3D_packet_v33_TEXTURE_SHADER_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                         const struct V3D_packet_v33_TEXTURE_SHADER_STATE * restrict values)
{
...
#define V3D_packet_v33_TEXTURE_SHADER_STATE_length     24
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_TEXTURE_SHADER_STATE_unpack(const uint8_t * restrict cl,
                                           struct V3D_packet_v33_TEXTURE_SHADER_STATE * restrict values)
{
...
#define V3D_packet_v33_SAMPLER_STATE_header     \


struct V3D_packet_v33_SAMPLER_STATE {
   ...
   enum V3D_packet_v33_Border_Color_Mode border_color_mode;
   bool                                 wrap_i_border;
   enum V3D_packet_v33_Wrap_Mode        wrap_r;
   enum V3D_packet_v33_Wrap_Mode        wrap_t;
   enum V3D_packet_v33_Wrap_Mode        wrap_s;
   float                                fixed_bias;
   float                                max_level_of_detail;
   float                                min_level_of_detail;
   bool                                 srgb_disable;
   enum V3D_packet_v33_Compare_Function depth_compare_function;
...
static inline void
V3D_packet_v33_SAMPLER_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                  const struct V3D_packet_v33_SAMPLER_STATE * restrict values)
{
...
#define V3D_packet_v33_SAMPLER_STATE_length     24
#ifdef __gen_unpack_address
static inline void
V3D_packet_v33_SAMPLER_STATE_unpack(const uint8_t * restrict cl,
                                    struct V3D_packet_v33_SAMPLER_STATE * restrict values)
{
...
enum V3D_packet_v33_Texture_Data_Formats {
