...
#ifndef V3D_packet_v21_PACK_H
#define V3D_packet_v21_PACK_H

#include "cle/v3d_packet_helpers.h"


enum V3D_packet_v21_Compare_Function {
...
#define V3D_packet_v21_HALT_opcode             0
#define V3D_packet_v21_HALT_header              \
   .opcode                              =      0

struct V3D_packet_v21_HALT {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v21_HALT_pack(__gen_user_data *data, uint8_t * restrict cl,
                         const struct V3D_packet_v21_HALT * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v21_HALT_length             1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_HALT_unpack(const uint8_t * restrict cl,
                           struct V3D_packet_v21_HALT * restrict values)
{
...
#define V3D_packet_v21_NOP_opcode              1
#define V3D_packet_v21_NOP_header               \
   .opcode                              =      1

struct V3D_packet_v21_NOP {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v21_NOP_pack(__gen_user_data *data, uint8_t * restrict cl,
                        const struct V3D_packet_v21_NOP * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v21_NOP_length              1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_NOP_unpack(const uint8_t * restrict cl,
                          struct V3D_packet_v21_NOP * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v21_FLUSH_opcode            4
#define V3D_packet_v21_FLUSH_header             \
   .opcode                              =      4

struct V3D_packet_v21_FLUSH {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v21_FLUSH_pack(__gen_user_data *data, uint8_t * restrict cl,
                          const struct V3D_packet_v21_FLUSH * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v21_FLUSH_length            1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_FLUSH_unpack(const uint8_t * restrict cl,
                            struct V3D_packet_v21_FLUSH * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v21_FLUSH_ALL_STATE_opcode      5
#define V3D_packet_v21_FLUSH_ALL_STATE_header   \
   .opcode                              =      5

struct V3D_packet_v21_FLUSH_ALL_STATE {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v21_FLUSH_ALL_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D_packet_v21_FLUSH_ALL_STATE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v21_FLUSH_ALL_STATE_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_FLUSH_ALL_STATE_unpack(const uint8_t * restrict cl,
                                      struct V3D_packet_v21_FLUSH_ALL_STATE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v21_START_TILE_BINNING_opcode      6
#define V3D_packet_v21_START_TILE_BINNING_header\
   .opcode                              =      6

struct V3D_packet_v21_START_TILE_BINNING {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v21_START_TILE_BINNING_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D_packet_v21_START_TILE_BINNING * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v21_START_TILE_BINNING_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_START_TILE_BINNING_unpack(const uint8_t * restrict cl,
                                         struct V3D_packet_v21_START_TILE_BINNING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v21_INCREMENT_SEMAPHORE_opcode      7
#define V3D_packet_v21_INCREMENT_SEMAPHORE_header\
   .opcode                              =      7

struct V3D_packet_v21_INCREMENT_SEMAPHORE {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v21_INCREMENT_SEMAPHORE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                        const struct V3D_packet_v21_INCREMENT_SEMAPHORE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v21_INCREMENT_SEMAPHORE_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_INCREMENT_SEMAPHORE_unpack(const uint8_t * restrict cl,
                                          struct V3D_packet_v21_INCREMENT_SEMAPHORE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v21_WAIT_ON_SEMAPHORE_opcode      8
#define V3D_packet_v21_WAIT_ON_SEMAPHORE_header \
   .opcode                              =      8

struct V3D_packet_v21_WAIT_ON_SEMAPHORE {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v21_WAIT_ON_SEMAPHORE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                      const struct V3D_packet_v21_WAIT_ON_SEMAPHORE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v21_WAIT_ON_SEMAPHORE_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_WAIT_ON_SEMAPHORE_unpack(const uint8_t * restrict cl,
                                        struct V3D_packet_v21_WAIT_ON_SEMAPHORE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v21_BRANCH_opcode          16
#define V3D_packet_v21_BRANCH_header            \
   .opcode                              =     16

struct V3D_packet_v21_BRANCH {
   uint32_t                             opcode;
   __gen_address_type                   address;
};

static inline void
V3D_packet_v21_BRANCH_pack(__gen_user_data *data, uint8_t * restrict cl,
                           const struct V3D_packet_v21_BRANCH * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_BRANCH_length           5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_BRANCH_unpack(const uint8_t * restrict cl,
                             struct V3D_packet_v21_BRANCH * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_BRANCH_TO_SUB_LIST_opcode     17
#define V3D_packet_v21_BRANCH_TO_SUB_LIST_header\
   .opcode                              =     17

struct V3D_packet_v21_BRANCH_TO_SUB_LIST {
   uint32_t                             opcode;
   __gen_address_type                   address;
};

static inline void
V3D_packet_v21_BRANCH_TO_SUB_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D_packet_v21_BRANCH_TO_SUB_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_BRANCH_TO_SUB_LIST_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_BRANCH_TO_SUB_LIST_unpack(const uint8_t * restrict cl,
                                         struct V3D_packet_v21_BRANCH_TO_SUB_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 8, 39);
}
...
#define V3D_packet_v21_RETURN_FROM_SUB_LIST_opcode     18
#define V3D_packet_v21_RETURN_FROM_SUB_LIST_header\
   .opcode                              =     18

struct V3D_packet_v21_RETURN_FROM_SUB_LIST {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v21_RETURN_FROM_SUB_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                         const struct V3D_packet_v21_RETURN_FROM_SUB_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v21_RETURN_FROM_SUB_LIST_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_RETURN_FROM_SUB_LIST_unpack(const uint8_t * restrict cl,
                                           struct V3D_packet_v21_RETURN_FROM_SUB_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_opcode     24
#define V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_header\
   .opcode                              =     24

struct V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                                  const struct V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_unpack(const uint8_t * restrict cl,
                                                                    struct V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_AND_EOF_opcode     25
#define V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_AND_EOF_header\
   .opcode                              =     25

struct V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_AND_EOF {
   uint32_t                             opcode;
};

static inline void
V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_AND_EOF_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                                          const struct V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_AND_EOF * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);

}

#define V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_AND_EOF_length      1
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_AND_EOF_unpack(const uint8_t * restrict cl,
                                                                            struct V3D_packet_v21_STORE_MULTI_SAMPLE_RESOLVED_TILE_COLOR_BUFFER_AND_EOF * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
}
#endif
...
#define V3D_packet_v21_STORE_FULL_RESOLUTION_TILE_BUFFER_opcode     26
#define V3D_packet_v21_STORE_FULL_RESOLUTION_TILE_BUFFER_header\
   .opcode                              =     26

struct V3D_packet_v21_STORE_FULL_RESOLUTION_TILE_BUFFER {
   uint32_t                             opcode;
   __gen_address_type                   address;
   bool                                 last_tile;
...
static inline void
V3D_packet_v21_STORE_FULL_RESOLUTION_TILE_BUFFER_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                      const struct V3D_packet_v21_STORE_FULL_RESOLUTION_TILE_BUFFER * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_STORE_FULL_RESOLUTION_TILE_BUFFER_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_STORE_FULL_RESOLUTION_TILE_BUFFER_unpack(const uint8_t * restrict cl,
                                                        struct V3D_packet_v21_STORE_FULL_RESOLUTION_TILE_BUFFER * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_RE_LOAD_FULL_RESOLUTION_TILE_BUFFER_opcode     27
#define V3D_packet_v21_RE_LOAD_FULL_RESOLUTION_TILE_BUFFER_header\
   .opcode                              =     27

struct V3D_packet_v21_RE_LOAD_FULL_RESOLUTION_TILE_BUFFER {
   uint32_t                             opcode;
   __gen_address_type                   address;
...
static inline void
V3D_packet_v21_RE_LOAD_FULL_RESOLUTION_TILE_BUFFER_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                        const struct V3D_packet_v21_RE_LOAD_FULL_RESOLUTION_TILE_BUFFER * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_RE_LOAD_FULL_RESOLUTION_TILE_BUFFER_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_RE_LOAD_FULL_RESOLUTION_TILE_BUFFER_unpack(const uint8_t * restrict cl,
                                                          struct V3D_packet_v21_RE_LOAD_FULL_RESOLUTION_TILE_BUFFER * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->address = __gen_unpack_address(cl, 12, 39);
...
#define V3D_packet_v21_STORE_TILE_BUFFER_GENERAL_opcode     28
#define V3D_packet_v21_STORE_TILE_BUFFER_GENERAL_header\
   .opcode                              =     28

struct V3D_packet_v21_STORE_TILE_BUFFER_GENERAL {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v21_STORE_TILE_BUFFER_GENERAL_pack(__gen_user_data *data, uint8_t * restrict cl,
                                              const struct V3D_packet_v21_STORE_TILE_BUFFER_GENERAL * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_STORE_TILE_BUFFER_GENERAL_length      7
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_STORE_TILE_BUFFER_GENERAL_unpack(const uint8_t * restrict cl,
                                                struct V3D_packet_v21_STORE_TILE_BUFFER_GENERAL * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_LOAD_TILE_BUFFER_GENERAL_opcode     29
#define V3D_packet_v21_LOAD_TILE_BUFFER_GENERAL_header\
   .opcode                              =     29

struct V3D_packet_v21_LOAD_TILE_BUFFER_GENERAL {
   uint32_t                             opcode;
   __gen_address_type                   memory_base_address_of_frame_tile_dump_buffer;
...
static inline void
V3D_packet_v21_LOAD_TILE_BUFFER_GENERAL_pack(__gen_user_data *data, uint8_t * restrict cl,
                                             const struct V3D_packet_v21_LOAD_TILE_BUFFER_GENERAL * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_LOAD_TILE_BUFFER_GENERAL_length      7
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_LOAD_TILE_BUFFER_GENERAL_unpack(const uint8_t * restrict cl,
                                               struct V3D_packet_v21_LOAD_TILE_BUFFER_GENERAL * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
   values->memory_base_address_of_frame_tile_dump_buffer = __gen_unpack_address(cl, 28, 55);
...
#define V3D_packet_v21_INDEXED_PRIMITIVE_LIST_opcode     32
#define V3D_packet_v21_INDEXED_PRIMITIVE_LIST_header\
   .opcode                              =     32

struct V3D_packet_v21_INDEXED_PRIMITIVE_LIST {
   uint32_t                             opcode;
...
#define _8_BIT                                   0
#define _16_BIT                                  1
   enum V3D_packet_v21_Primitive        primitive_mode;
};

static inline void
V3D_packet_v21_INDEXED_PRIMITIVE_LIST_pack(__gen_user_data *data, uint8_t * restrict cl,
                                           const struct V3D_packet_v21_INDEXED_PRIMITIVE_LIST * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_INDEXED_PRIMITIVE_LIST_length     14
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_INDEXED_PRIMITIVE_LIST_unpack(const uint8_t * restrict cl,
                                             struct V3D_packet_v21_INDEXED_PRIMITIVE_LIST * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_VERTEX_ARRAY_PRIMITIVES_opcode     33
#define V3D_packet_v21_VERTEX_ARRAY_PRIMITIVES_header\
   .opcode                              =     33

struct V3D_packet_v21_VERTEX_ARRAY_PRIMITIVES {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v21_VERTEX_ARRAY_PRIMITIVES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                            const struct V3D_packet_v21_VERTEX_ARRAY_PRIMITIVES * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_VERTEX_ARRAY_PRIMITIVES_length     10
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_VERTEX_ARRAY_PRIMITIVES_unpack(const uint8_t * restrict cl,
                                              struct V3D_packet_v21_VERTEX_ARRAY_PRIMITIVES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_PRIMITIVE_LIST_FORMAT_opcode     56
#define V3D_packet_v21_PRIMITIVE_LIST_FORMAT_header\
   .opcode                              =     56

struct V3D_packet_v21_PRIMITIVE_LIST_FORMAT {
   uint32_t                             opcode;
   uint32_t                             data_type;
...
static inline void
V3D_packet_v21_PRIMITIVE_LIST_FORMAT_pack(__gen_user_data *data, uint8_t * restrict cl,
                                          const struct V3D_packet_v21_PRIMITIVE_LIST_FORMAT * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_PRIMITIVE_LIST_FORMAT_length      2
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_PRIMITIVE_LIST_FORMAT_unpack(const uint8_t * restrict cl,
                                            struct V3D_packet_v21_PRIMITIVE_LIST_FORMAT * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_GL_SHADER_STATE_opcode     64
#define V3D_packet_v21_GL_SHADER_STATE_header   \
   .opcode                              =     64

struct V3D_packet_v21_GL_SHADER_STATE {
   uint32_t                             opcode;
   uint32_t                             address;
...
static inline void
V3D_packet_v21_GL_SHADER_STATE_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D_packet_v21_GL_SHADER_STATE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_GL_SHADER_STATE_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_GL_SHADER_STATE_unpack(const uint8_t * restrict cl,
                                      struct V3D_packet_v21_GL_SHADER_STATE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_CLEAR_COLORS_opcode    114
#define V3D_packet_v21_CLEAR_COLORS_header      \
   .opcode                              =    114

struct V3D_packet_v21_CLEAR_COLORS {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v21_CLEAR_COLORS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                 const struct V3D_packet_v21_CLEAR_COLORS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_CLEAR_COLORS_length     14
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_CLEAR_COLORS_unpack(const uint8_t * restrict cl,
                                   struct V3D_packet_v21_CLEAR_COLORS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_CONFIGURATION_BITS_opcode     96
#define V3D_packet_v21_CONFIGURATION_BITS_header\
   .opcode                              =     96

struct V3D_packet_v21_CONFIGURATION_BITS {
   uint32_t                             opcode;
   bool                                 early_z_updates_enable;
   bool                                 early_z_enable;
   bool                                 z_updates_enable;
   enum V3D_packet_v21_Compare_Function depth_test_function;
...
static inline void
V3D_packet_v21_CONFIGURATION_BITS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D_packet_v21_CONFIGURATION_BITS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_CONFIGURATION_BITS_length      4
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_CONFIGURATION_BITS_unpack(const uint8_t * restrict cl,
                                         struct V3D_packet_v21_CONFIGURATION_BITS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_FLAT_SHADE_FLAGS_opcode     97
#define V3D_packet_v21_FLAT_SHADE_FLAGS_header  \
   .opcode                              =     97

struct V3D_packet_v21_FLAT_SHADE_FLAGS {
   uint32_t                             opcode;
   uint32_t                             flat_shading_flags;
};

static inline void
V3D_packet_v21_FLAT_SHADE_FLAGS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D_packet_v21_FLAT_SHADE_FLAGS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_FLAT_SHADE_FLAGS_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_FLAT_SHADE_FLAGS_unpack(const uint8_t * restrict cl,
                                       struct V3D_packet_v21_FLAT_SHADE_FLAGS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_POINT_SIZE_opcode      98
#define V3D_packet_v21_POINT_SIZE_header        \
   .opcode                              =     98

struct V3D_packet_v21_POINT_SIZE {
   uint32_t                             opcode;
   float                                point_size;
};

static inline void
V3D_packet_v21_POINT_SIZE_pack(__gen_user_data *data, uint8_t * restrict cl,
                               const struct V3D_packet_v21_POINT_SIZE * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_POINT_SIZE_length       5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_POINT_SIZE_unpack(const uint8_t * restrict cl,
                                 struct V3D_packet_v21_POINT_SIZE * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_LINE_WIDTH_opcode      99
#define V3D_packet_v21_LINE_WIDTH_header        \
   .opcode                              =     99

struct V3D_packet_v21_LINE_WIDTH {
   uint32_t                             opcode;
   float                                line_width;
};

static inline void
V3D_packet_v21_LINE_WIDTH_pack(__gen_user_data *data, uint8_t * restrict cl,
                               const struct V3D_packet_v21_LINE_WIDTH * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_LINE_WIDTH_length       5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_LINE_WIDTH_unpack(const uint8_t * restrict cl,
                                 struct V3D_packet_v21_LINE_WIDTH * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_RHT_X_BOUNDARY_opcode    100
#define V3D_packet_v21_RHT_X_BOUNDARY_header    \
   .opcode                              =    100

struct V3D_packet_v21_RHT_X_BOUNDARY {
   uint32_t                             opcode;
   int32_t                              rht_primitive_x_boundary;
};

static inline void
V3D_packet_v21_RHT_X_BOUNDARY_pack(__gen_user_data *data, uint8_t * restrict cl,
                                   const struct V3D_packet_v21_RHT_X_BOUNDARY * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_RHT_X_BOUNDARY_length      3
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_RHT_X_BOUNDARY_unpack(const uint8_t * restrict cl,
                                     struct V3D_packet_v21_RHT_X_BOUNDARY * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_DEPTH_OFFSET_opcode    101
#define V3D_packet_v21_DEPTH_OFFSET_header      \
   .opcode                              =    101

struct V3D_packet_v21_DEPTH_OFFSET {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v21_DEPTH_OFFSET_pack(__gen_user_data *data, uint8_t * restrict cl,
                                 const struct V3D_packet_v21_DEPTH_OFFSET * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_DEPTH_OFFSET_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_DEPTH_OFFSET_unpack(const uint8_t * restrict cl,
                                   struct V3D_packet_v21_DEPTH_OFFSET * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_CLIP_WINDOW_opcode    102
#define V3D_packet_v21_CLIP_WINDOW_header       \
   .opcode                              =    102

struct V3D_packet_v21_CLIP_WINDOW {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v21_CLIP_WINDOW_pack(__gen_user_data *data, uint8_t * restrict cl,
                                const struct V3D_packet_v21_CLIP_WINDOW * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_CLIP_WINDOW_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_CLIP_WINDOW_unpack(const uint8_t * restrict cl,
                                  struct V3D_packet_v21_CLIP_WINDOW * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_VIEWPORT_OFFSET_opcode    103
#define V3D_packet_v21_VIEWPORT_OFFSET_header   \
   .opcode                              =    103

struct V3D_packet_v21_VIEWPORT_OFFSET {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v21_VIEWPORT_OFFSET_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D_packet_v21_VIEWPORT_OFFSET * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_VIEWPORT_OFFSET_length      5
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_VIEWPORT_OFFSET_unpack(const uint8_t * restrict cl,
                                      struct V3D_packet_v21_VIEWPORT_OFFSET * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_Z_MIN_AND_MAX_CLIPPING_PLANES_opcode    104
#define V3D_packet_v21_Z_MIN_AND_MAX_CLIPPING_PLANES_header\
   .opcode                              =    104

struct V3D_packet_v21_Z_MIN_AND_MAX_CLIPPING_PLANES {
   uint32_t                             opcode;
   float                                maximum_zw;
   float                                minimum_zw;
};
...
static inline void
V3D_packet_v21_Z_MIN_AND_MAX_CLIPPING_PLANES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                  const struct V3D_packet_v21_Z_MIN_AND_MAX_CLIPPING_PLANES * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_Z_MIN_AND_MAX_CLIPPING_PLANES_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_Z_MIN_AND_MAX_CLIPPING_PLANES_unpack(const uint8_t * restrict cl,
                                                    struct V3D_packet_v21_Z_MIN_AND_MAX_CLIPPING_PLANES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_CLIPPER_XY_SCALING_opcode    105
#define V3D_packet_v21_CLIPPER_XY_SCALING_header\
   .opcode                              =    105

struct V3D_packet_v21_CLIPPER_XY_SCALING {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v21_CLIPPER_XY_SCALING_pack(__gen_user_data *data, uint8_t * restrict cl,
                                       const struct V3D_packet_v21_CLIPPER_XY_SCALING * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_CLIPPER_XY_SCALING_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_CLIPPER_XY_SCALING_unpack(const uint8_t * restrict cl,
                                         struct V3D_packet_v21_CLIPPER_XY_SCALING * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_CLIPPER_Z_SCALE_AND_OFFSET_opcode    106
#define V3D_packet_v21_CLIPPER_Z_SCALE_AND_OFFSET_header\
   .opcode                              =    106

struct V3D_packet_v21_CLIPPER_Z_SCALE_AND_OFFSET {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v21_CLIPPER_Z_SCALE_AND_OFFSET_pack(__gen_user_data *data, uint8_t * restrict cl,
                                               const struct V3D_packet_v21_CLIPPER_Z_SCALE_AND_OFFSET * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_CLIPPER_Z_SCALE_AND_OFFSET_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_CLIPPER_Z_SCALE_AND_OFFSET_unpack(const uint8_t * restrict cl,
                                                 struct V3D_packet_v21_CLIPPER_Z_SCALE_AND_OFFSET * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_TILE_BINNING_MODE_CONFIGURATION_opcode    112
#define V3D_packet_v21_TILE_BINNING_MODE_CONFIGURATION_header\
   .opcode                              =    112

struct V3D_packet_v21_TILE_BINNING_MODE_CONFIGURATION {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v21_TILE_BINNING_MODE_CONFIGURATION_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                    const struct V3D_packet_v21_TILE_BINNING_MODE_CONFIGURATION * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_TILE_BINNING_MODE_CONFIGURATION_length     16
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_TILE_BINNING_MODE_CONFIGURATION_unpack(const uint8_t * restrict cl,
                                                      struct V3D_packet_v21_TILE_BINNING_MODE_CONFIGURATION * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_TILE_RENDERING_MODE_CONFIGURATION_opcode    113
#define V3D_packet_v21_TILE_RENDERING_MODE_CONFIGURATION_header\
   .opcode                              =    113

struct V3D_packet_v21_TILE_RENDERING_MODE_CONFIGURATION {
   uint32_t                             opcode;
   bool                                 double_buffer_in_non_ms_mode;
...
static inline void
V3D_packet_v21_TILE_RENDERING_MODE_CONFIGURATION_pack(__gen_user_data *data, uint8_t * restrict cl,
                                                      const struct V3D_packet_v21_TILE_RENDERING_MODE_CONFIGURATION * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_TILE_RENDERING_MODE_CONFIGURATION_length     11
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_TILE_RENDERING_MODE_CONFIGURATION_unpack(const uint8_t * restrict cl,
                                                        struct V3D_packet_v21_TILE_RENDERING_MODE_CONFIGURATION * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_TILE_COORDINATES_opcode    115
#define V3D_packet_v21_TILE_COORDINATES_header  \
   .opcode                              =    115

struct V3D_packet_v21_TILE_COORDINATES {
   uint32_t                             opcode;
...
static inline void
V3D_packet_v21_TILE_COORDINATES_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D_packet_v21_TILE_COORDINATES * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_TILE_COORDINATES_length      3
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_TILE_COORDINATES_unpack(const uint8_t * restrict cl,
                                       struct V3D_packet_v21_TILE_COORDINATES * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_GEM_RELOCATIONS_opcode    254
#define V3D_packet_v21_GEM_RELOCATIONS_header   \
   .opcode                              =    254

struct V3D_packet_v21_GEM_RELOCATIONS {
   uint32_t                             opcode;
   uint32_t                             buffer_1;
   uint32_t                             buffer_0;
};
...
static inline void
V3D_packet_v21_GEM_RELOCATIONS_pack(__gen_user_data *data, uint8_t * restrict cl,
                                    const struct V3D_packet_v21_GEM_RELOCATIONS * restrict values)
{
   cl[ 0] = __gen_uint(values->opcode, 0, 7);
...
#define V3D_packet_v21_GEM_RELOCATIONS_length      9
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_GEM_RELOCATIONS_unpack(const uint8_t * restrict cl,
                                      struct V3D_packet_v21_GEM_RELOCATIONS * restrict values)
{
   values->opcode = __gen_unpack_uint(cl, 0, 7);
...
#define V3D_packet_v21_SHADER_RECORD_header     \


struct V3D_packet_v21_SHADER_RECORD {
...
static inline void
V3D_packet_v21_SHADER_RECORD_pack(__gen_user_data *data, uint8_t * restrict cl,
                                  const struct V3D_packet_v21_SHADER_RECORD * restrict values)
{
...
#define V3D_packet_v21_SHADER_RECORD_length     36
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_SHADER_RECORD_unpack(const uint8_t * restrict cl,
                                    struct V3D_packet_v21_SHADER_RECORD * restrict values)
{
...
#define V3D_packet_v21_ATTRIBUTE_RECORD_header  \


struct V3D_packet_v21_ATTRIBUTE_RECORD {
   __gen_address_type                   address;
...
static inline void
V3D_packet_v21_ATTRIBUTE_RECORD_pack(__gen_user_data *data, uint8_t * restrict cl,
                                     const struct V3D_packet_v21_ATTRIBUTE_RECORD * restrict values)
{
   __gen_emit_reloc(data, &values->address);
...
#define V3D_packet_v21_ATTRIBUTE_RECORD_length      8
#ifdef __gen_unpack_address
static inline void
V3D_packet_v21_ATTRIBUTE_RECORD_unpack(const uint8_t * restrict cl,
                                       struct V3D_packet_v21_ATTRIBUTE_RECORD * restrict values)
{
